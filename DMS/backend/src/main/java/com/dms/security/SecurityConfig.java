...
public class SecurityConfig {
    ...
    private final SessionQuotaFilter sessionQuotaFilter;

    public SecurityConfig(SessionQuotaFilter sessionQuotaFilter) {
        this.sessionQuotaFilter = sessionQuotaFilter;
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/admin/users", "/api/admin/users/**", "/api/admin/groups", "/api/admin/groups/**").hasAnyRole("ROOT", "SYS_ADMIN", "USER_ADMIN")
                .requestMatchers("/api/admin/**").hasAnyRole("ROOT", "SYS_ADMIN")
            ...
            .addFilterAfter(sessionQuotaFilter, BasicAuthenticationFilter.class);
        return http.build();
    }
