 ...
 */
export declare enum SANEStatus {
    GOOD = 0,
    UNSUPPORTED = 1,
    CANCELLED = 2,
    DEVICE_BUSY = 3,
 ...
 */
export declare enum SANEValueType {
    BOOL = 0,
    INT = 1,
    FIXED = 2,
    STRING = 3,
 ...
 */
export declare enum SANEConstraintType {
    NONE = 0,
    RANGE = 1,
    WORD_LIST = 2,
    STRING_LIST = 3
...
export interface LibSANE {
    ...
    sane_init: () => {
        ...
        status: Exclude<SANEStatus, SANEStatus.GOOD>;
        version_code: null;
    };
    /**
     ...
     */
    sane_open: (devicename: string) => Promise<{
        status: SANEStatus;
    }>;
    /**
     ...
     */
    sane_get_option_descriptor: (option: number) => {
        status: SANEStatus;
        option_descriptor: SANEOptionDescriptor | null;
    };
    /**
     ...
     * @see {@link https://sane-project.gitlab.io/standard/1.06/api.html#sane-control-option}
     */
    sane_control_option_get_value: (option: number) => Promise<{
        status: SANEStatus.GOOD;
        value: any;
    } | {
        status: Exclude<SANEStatus, SANEStatus.GOOD>;
     ...
     * @see {@link https://sane-project.gitlab.io/standard/1.06/api.html#sane-control-option}
     */
    sane_control_option_set_value: (option: number, value: any) => Promise<{
        status: SANEStatus.GOOD;
        info: SANEInfo;
    } | {
        status: Exclude<SANEStatus, SANEStatus.GOOD>;
     ...
     * @see {@link https://sane-project.gitlab.io/standard/1.06/api.html#sane-control-option}
     */
    sane_control_option_set_auto: (option: number) => Promise<{
        status: SANEStatus.GOOD;
        info: SANEInfo;
    } | {
        status: Exclude<SANEStatus, SANEStatus.GOOD>;
 ...
 */
export declare const libsane: LibSANEFactory;
/**
